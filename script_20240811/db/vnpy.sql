...
CREATE TABLE `account`  (
  ...
  `initial_margin` decimal(20, 2) NOT NULL DEFAULT 0.00 COMMENT '初始保证金',
  `margin` decimal(20, 2) NOT NULL DEFAULT 0.00 COMMENT '现在保证金',
...
-- Records of kv
-- ----------------------------
INSERT INTO `kv` VALUES (1, '操作时间点', '', 'target_time', '14:55:00');
...
INSERT INTO `kv` VALUES (9, '接收操作邮箱', '用于接收操作提醒邮件的邮箱号', 'get_email_username', 'ak490216135@gmail.com');
